...
import lando.systems.ld55.assets.InputPrompts;
...
public class SettingsUI extends Group {
    ...
    public com.badlogic.gdx.scenes.scene2d.ui.ImageButton closeSettingsButton;
    ...
    public SettingsUI(Skin skin, OrthographicCamera windowCamera) {
        super();
...
//        settingsPane.setColor(Color.DARK_GRAY);
        ...
        com.badlogic.gdx.scenes.scene2d.ui.ImageButton.ImageButtonStyle closeButtonStyle = new com.badlogic.gdx.scenes.scene2d.ui.ImageButton.ImageButtonStyle(defaultButtonStyle);
...
//        settingsButtonStyle.font = assets.smallFont;
        settingsButtonStyle.font = assets.fontAbandonedMed;
